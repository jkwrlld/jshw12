...
// function calculateTotalPrice(allProdcuts, product

const powers = [20, 45, 70, 15];

const result = powers.map((power, index, arr) => power * 2);
console.log(result);
const filterPowers = powers.filter((power, index, arr) => power > 30);
console.log(filterPowers);
